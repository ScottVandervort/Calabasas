...
-------------------------------------------
	...
	[ ] Display face state to on-screen text; i.e., "happy", "right-eye closed", etc...

	[ ] Mouse click should display the index of the face point

	[ ] Determine indices in the points Kinect points array for each facial shape; Create enums for each.

	[ ] Allow toggling between labeled points and lines
